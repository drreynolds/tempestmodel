function [qE,qI,q] = check_ark2(cE,cI,AE,AI,bE,bI,tol,reportL,doPlot,box,mname,fname)
% Usage: [qE,qI,q] = check_ark2(cE,cI,AE,AI,bE,bI,tol,reportL,doPlot,box,mname,fname)
% 

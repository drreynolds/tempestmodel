function [qE,qI,q,pE,pI,p] = check_ark_embedded2(cE,cI,AE,AI,bE,bI,dE,dI,tol,reportL,doPlot,box,mname,fname)
% Usage: [qE,qI,q,pE,pI,p] = check_ark_embedded2(cE,cI,AE,AI,bE,bI,dE,dI,tol,reportL,doPlot,box,mname,fname)
% 
...
if (doPlot)
   ...
   [X,Y] = stab_region2(AE, bE, box);     % ERK stability region boundary
   plot(X, Y, 'r-')
   [X,Y] = stab_region2(AE, dE, box);     % ERK embedding stability region boundary
   plot(X, Y, 'g-')
   [X,Y] = stab_region2(AI, bI, box);     % DIRK stability region boundary
   plot(X, Y, 'b-')
   [X,Y] = stab_region2(AI, dI, box);     % DIRK embedding stability region boundary
   plot(X, Y, 'm-')

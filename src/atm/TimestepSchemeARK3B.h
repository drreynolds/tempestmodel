...
#ifndef _TIMESTEPSCHEMEARK3B_H_
#define _TIMESTEPSCHEMEARK3B_H_
...
///	</summary>
class TimestepSchemeARK3B : public TimestepScheme {
...
private:
    ///	<summary>
	///		ARK3B parameter gamma
	///	</summary>
	static const double m_dgamma;
	///	<summary>
	///		ARK3B parameter delta
	///	</summary>
	static const double m_ddelta;

    ///	<summary>
	///		Coefficients for the time increment ARK3B.
	///	</summary>
	static const double m_dTimeCf[3];

    ///	<summary>
	///		Coefficients for the explicit ARK3B.
	///	</summary>
